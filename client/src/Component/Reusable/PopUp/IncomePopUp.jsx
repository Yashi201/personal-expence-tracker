...
function IncomePopUp({ open, onClose }) {
  ...
  return (
    <>
      <div className="flex justify-center items-center overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none border-5">
        <div className="relative w-1/2 my-6 mx-auto max-w-screen-2xl">
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            <div className="p-5 border-b border-solid border-gray-300 rounded-lg">
              <div className="header_pop_up_content flex flex-row items-start content-center justify-between ">
                <h3 className="text-3xl font-semibold">Add New Income</h3>
                <button
