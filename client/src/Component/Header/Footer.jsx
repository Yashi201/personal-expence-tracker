...
function Footer() {
  ...
  <div className="bg-slate-600">
    <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
      ...
      <p className="text-sm text-white sm:ml-6 sm:mt-0 mt-4">© 2020 Tailblocks —
        <Link href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="text-white ml-1" target="_blank">@knyttneve</Link  >
      </p>
